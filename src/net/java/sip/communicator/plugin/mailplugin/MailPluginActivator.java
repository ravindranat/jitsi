 ...
 */
package net.java.sip.communicator.plugin.mailplugin;
...
/**
 * The <tt>MailPluginActivator</tt> is the entering point for the mail
 * plugin bundle.
 *
 * @author A.P. Grin
 */
public class MailPluginActivator
    implements BundleActivator
{
    Logger logger = Logger.getLogger(MailPluginActivator.class);
